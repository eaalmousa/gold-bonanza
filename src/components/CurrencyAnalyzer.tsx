...
import { Search, Activity, TrendingUp, Crosshair, AlertTriangle, ChevronRight, CheckCircle, XCircle, Minus, Rocket } from 'lucide-react';
...
async function runRealAnalysis(symbol: string): Promise<RealAnalysis> {
  ...
  const priceLabel = currentPrice >= 10 ? currentPrice.toFixed(2) : currentPrice >= 1 ? currentPrice.toFixed(4) : currentPrice.toFixed(6);
